class ArithmeticExceptionDemo1 extends RuntimeException
{
	ArithmeticExceptionDemo1(String message){
		super(message);
	}
	public static void main(String[] args) 
	{
		try{
		throw new ArithmeticExceptionDemo1("/ by zero problem ");
		}catch(ArithmeticExceptionDemo1 obj1){
